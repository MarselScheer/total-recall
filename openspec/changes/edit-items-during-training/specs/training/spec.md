...
#### Scenario: Edit is available when answer is revealed
...
#### Scenario: Edit is disabled when answer is hidden
...
#### Scenario: Commit does not modify schedule
...
#### Scenario: Commit preserves id and created timestamp
...
#### Scenario: Term or definition cannot be empty
...
#### Scenario: Edited item is immediately updated in the training display
